    ...
    return (<>
        ...
        <div id="rightBar" className="fixed right-0 h-full w-1/6 px-4 py-8 border-l bg-black border-gray-600">
            ...
            <div className="flex flex-col justify-between flex-1 mt-6">
                {/* <nav>
                    <a className="flex items-center px-4 py-2 text-gray-700 bg-gray-200 rounded-md bg-gray-700 text-gray-200" href="#">
                    ...
                    <a className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md text-gray-400 hover:bg-gray-200 hover:bg-gray-700 hover:text-gray-200 hover:text-gray-700" href="#">
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <hr className="my-6 border-gray-200 border-gray-600" />
