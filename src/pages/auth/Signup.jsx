              ...
              <form onSubmit={handleSignup}>
                <div className="mt-6">
                  ...
                  <div className="flex flex-col justify-between items-start mb-2">
                    <label htmlFor="username" className="text-left block text-sm text-gray-600 dark:text-gray-200">Username</label>
                ...
                <div className="mt-6">
                  ...
                  <div className="flex flex-col justify-between items-start mb-2">
                    <label htmlFor="email" className="text-left block text-sm text-gray-600 dark:text-gray-200">Email Address</label>
                ...
                <div className="mt-6">
                  <div className="flex justify-between items-end mb-2">
                    <label htmlFor="password" className="text-sm text-gray-600 dark:text-gray-200">Repeat password</label>
                  </div>
